...
export default function InducteesPage() {
  const inductionYears = [2012, 2009]
        ...
        <div className="hof-container flex flex-col items-center">
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-[var(--gold)]">{inductees.length}</div>
            ...
            <div className="hof-container flex flex-col items-center">
              <div className="w-full max-w-5xl">
                <div className="flex items-center gap-4 mb-10">
                  <div className="w-16 h-48 lg:h-auto min-h-[200px] flex items-center justify-center relative">
                  ...
                  {yearInductees.map((inductee) => (
                    ...
                    >
                      <div className="grid lg:grid-cols-3">
                        ...
                        <div className="bg-[var(--navy)] h-48 lg:h-auto min-h-[200px] flex items-center justify-center relative">
                          <div className="text-6xl lg:text-8xl text-white/20 font-bold">
                            {inductee.name
                              .split(" ")
                              .map((n) => n[0])
