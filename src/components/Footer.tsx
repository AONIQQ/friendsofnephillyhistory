        ...
        <div className="hof-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              <Link href="/" className="flex items-center gap-3 mb-6 group">
                ...
                <div className="flex flex-col">
                  <span className="text-lg font-bold font-serif leading-none text-white">Northeast Phila</span>
                  <span className="text-sm font-bold text-[var(--gold)] uppercase tracking-wider">Hall of Fame</span>
                </div>
              </Link>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-10 h-10 bg-white/10 hover:bg-[var(--gold)] hover:text-[var(--navy)] rounded-lg flex items-center justify-center transition-all duration-300"
                  aria-label="Facebook"
                >
            ...
            <div>
              ...
              <p className="text-white/70 mb-5">Subscribe for updates on events and new inductees.</p>
